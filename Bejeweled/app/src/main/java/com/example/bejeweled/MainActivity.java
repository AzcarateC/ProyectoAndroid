...
///////////////////////////////////////////BOTONES////////////////////////////////////////////////////////////////////////
    ...
    public void onClickRefesh(View view) {
        if (masMovimiento()){
            Toast.makeText(MainActivity.this, "Disabled button", Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void compartir(View v){
        ...
        i.putExtra(Intent.EXTRA_TEXT,"Puntaje");
        this.shareActionProvider.setShareIntent(i);*/
        Toast.makeText(MainActivity.this, "No funciona todavia", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onClickVerificarPuntaje(View view) {
        ...
        if(numRows < 10){
            ...
            int cantidad = 0;
                do {
                    String codigo = registros.getString(0);
